...
# Constants
AZURE_OPENAI_MODEL = "gpt-4o-mini" # ["gpt-4o", "gpt-4o-mini", "o4-mini", "gpt-4.1-mini", "gpt-4.1", "o3-mini"]
AZURE_OPENAI_DEPLOYMENT = "aiobs360-gpt-4o-mini" # ["${var.base_name}-gpt-4o", "${var.base_name}-gpt-4o-mini", "${var.base_name}-o4-mini", "${var.base_name}-gpt-4.1-mini", "${var.base_name}-gpt-4.1", "${var.base_name}-o3-mini"]
